@AbapCatalog.sqlViewName: 'ZCDSUX403FLT05'
@EndUserText.label: 'UX403 Searching and Filtering'
@UI.headerInfo.typeNamePlural: 'Sales Orders'
@OData.publish: true
@Search.searchable: true

define view ZCDS_UX403_FILT_05
  as select from SEPM_I_SalesOrder
  association [1] to C_UX403CustomerVH as _CustomerVH on $projection.CustomerID = _CustomerVH.CustomerID
{
